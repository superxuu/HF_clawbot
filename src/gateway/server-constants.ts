export const MAX_PAYLOAD_BYTES = 25 * 1024 * 1024; // cap incoming frame size (25MB)
export const MAX_BUFFERED_BYTES = 64 * 1024 * 1024; // per-connection send buffer limit (64MB)
